...
class SuggestedDonationsPage extends StatelessWidget {
  const SuggestedDonationsPage({super.key});
          ...
          children: [
            const Padding(
              ...
              child: Row(
                ...
                children: [
                  Text('إقتراحاتنا', style: TextStyle(fontSize: 24)),
                  // SizedBox(
                  //   width: 20,
                  // ),
                  // Icon(
            ...
            FutureBuilder(
                future: DatabaseService().getDonationsForUser(uid: 'vElut40YexcHxl20BrwPNTsEuTe2'),
